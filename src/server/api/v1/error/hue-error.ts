...
export class HueError extends Error {
  ...
  static readonly PARAMETER_NOT_MODIFIABLE_DEVICE_OFF = new HueError(
    201,
    "parameter, %s, is not modifiable. Device is set to off"
  );
  ...
  static readonly GROUP_NO_UPDATE_DELETE = new HueError(
    305,
    "It is not allowed to update or delete group of this type"
  );
